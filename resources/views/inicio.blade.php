...
<head>
  ...
  <link rel="stylesheet" href="{{URL::to('/')}}/EasyAutocomplete/easy-autocomplete.min.css">
...
<body class="">
  <div class="presentation">
    ...
    <div class="input-group flex-nowrap col-md-10 mb-6" id="Title">
      ...
      @endif
        ...
        {{ csrf_field() }}
        <input class="form-control" id="userSearch" name="userSearch" type="search" placeholder="Ingrese usuario" aria-label="Search" required>
  ...
  <table class="table shadow-lg p-3 mb-5 bg-white rounded">
    ...
    <script src="{{URL::to('/')}}/Jquery/jquery-3.4.1.js" type="text/javascript"></script>z
    <script src="{{URL::to('/')}}/EasyAutocomplete/jquery.easy-autocomplete.min.js" type="text/javascript"></script>
